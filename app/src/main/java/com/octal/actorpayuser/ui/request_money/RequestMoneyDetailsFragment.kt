...
import com.octal.actorpayuser.databinding.FragmentRequestMoneyDetailsBinding
...
class RequestMoneyDetailsFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_request_money_details,container,false)
