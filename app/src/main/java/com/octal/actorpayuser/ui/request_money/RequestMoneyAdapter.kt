...
import com.octal.actorpayuser.databinding.RowRequestMoneyRecieveBinding
import com.octal.actorpayuser.databinding.RowRequestMoneySendBinding
import com.octal.actorpayuser.repositories.AppConstance.Clicks
import com.octal.actorpayuser.repositories.methods.MethodsRepo
import com.octal.actorpayuser.repositories.retrofitrepository.models.wallet.RequestMoneyData
...
class RequestMoneyAdapter(val myUserId:String,val methodsRepo: MethodsRepo, val items:MutableList<RequestMoneyData>, val onClick:(Clicks,Int)->Unit):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewtype == 0) {
            val viewHolderSend=holder as RequestMoneyAdapter.ViewHolderSend
            viewHolderSend.bindView(position)
        }
        else {
            val viewHolderRecieve=holder as RequestMoneyAdapter.ViewHolderRecieve
