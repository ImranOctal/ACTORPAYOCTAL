...
//        apiResponse()
    ...
    private fun onItemClickListener(position: Int, mList: List<String>) {
        ...
        when (mList[position]) {
            ...
            "Request Money" -> {
                if (fragment !is WalletBottomFragment) {
                    navController.navigate(R.id.requestMoneyFragment)
                }
            }
            "Mobile & DTH" -> {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
                ...
                R.id.historyBottomFragment -> {
                    ...
                    updateUI("My History",true,true,false,true)
                }
                R.id.walletBottomFragment -> {
                    binding.layoutMainID.bottomNavigationView.menu.getItem(3).isChecked = true
                    updateUI("My Wallet",true,false,true,false)
                }
                R.id.profileBottomFragment -> {
                    binding.layoutMainID.bottomNavigationView.menu.getItem(4).isChecked = true
                    updateUI("My Profile",true,true,false,true)
                }
                R.id.referFragment -> {
                    updateUI("My Refer",false,false,false,false)
                }
                R.id.rewardsFragment -> {
                    updateUI("My Rewards",false,false,false,false)
                }
                R.id.productListFragment -> {
                    updateUI("Products",false,true,false,false)
                }
                R.id.miscFragment -> {
                    updateUI("More",false,false,false,false)
                }
                R.id.myOrderFragment -> {
                    updateUI("My Orders",false,false,true,false)
                }
                R.id.promoListFragment -> {
                    updateUI("Promos",false,false,false,false)
                }
                R.id.settingsFragment -> {
                    updateUI("Settings",false,false,false,false)
                }
                R.id.faqFragment -> {
                    updateUI("FAQ",false,false,false,false)
                }
                R.id.remittance -> {
                    updateUI(getString(R.string.change_payment_option),false,false,false,false)
                }
                R.id.shippingAddressFragment -> {
                    updateUI("My Addresses",false,false,false,false)
                }
                R.id.orderDetailsFragment -> {
                    updateUI("Order Summary",false,false,false,false)
                }
                R.id.addMoneyFragment -> {
                    updateUI("Add Money In Wallet",false,false,false,false)

                }
                R.id.transferMoneyFragment -> {
                    updateUI("Transfer Money",false,false,false,false)
                ...
                R.id.requestMoneyFragment -> {
                    updateUI("Request Money",false,false,true,false)
                    binding.layoutMainID.constraintLayout.setBackgroundResource(R.color.white)
                }
                R.id.requestMoneyDetailsFragment -> {
                    updateUI("Request Money Details",false,false,false,false)
                }
                R.id.receiveFragment -> {
                    updateUI("Request Money",false,false,false,false)
                }
                R.id.mobileAndDTHFragment -> {
                    updateUI("Mobile and DTH Recharge",false,false,false,false)
                }
                R.id.notificationFragment -> {
                    updateUI("Notifications",false,false,false,false)
                }
                R.id.disputeFragment -> {
                    updateUI("Disputes",false,false,true,false)
                }
                R.id.disputeDetailsFragment -> {
                    updateUI("Dispute Details",false,false,false,false)
                }
                R.id.cartFragment -> {
                    updateUI("My Cart",false,true,false,false)

                }
                R.id.productDetailsFragment -> {
                    updateUI("Product Details",false,false,false,false)
                }
                R.id.placeOrderFragment -> {
                    updateUI("Place Order",false,false,false,false)
                }
                R.id.walletDetailsFragment -> {
                    updateUI("Transaction Details",false,false,false,false)
                }
