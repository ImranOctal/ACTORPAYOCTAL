...
data class SocialParams(val firstName: String,val lastName: String,val email: String,val googleId: String,val imageUrl: String,val deviceInfo:DeviceInfoParams)
